...
public class RouteDAO {
    ...
    public static String ROUTE_PROGRESSION = "ROUTE_PROGRESSION";
    public static final String TABLE_NAME = "PROGRESSION_TABLE";

    private AppDatabase database;

    public static String fetchTableSignature(){
    ...
    public List<String> getProgessionListByName(){
        ...
        Cursor c = readableDatabase.query(TABLE_NAME, null, null, null, null, null, null);
        while (c.moveToNext()){
